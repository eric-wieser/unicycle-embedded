 ...
 // This makes sure we only show these after we've done the measurements
    if (Serial.available() > 0) {
      ...
      if (mode == 'W') {
        ...
        Serial.println(' ');
        //Serial.print('1');
        for (int k=0; k<H; k++) {Serial.print(drollArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('2');
        for (int k=0; k<H; k++) {Serial.print(dyawArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('3');
        for (int k=0; k<H; k++) {Serial.print(dAngleWArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('4');
        for (int k=0; k<H; k++) {Serial.print(dpitchArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('5');
        for (int k=0; k<H; k++) {Serial.print(dAngleTTArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('6');
        for (int k=0; k<H; k++) {Serial.print(xOriginArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('7');
        for (int k=0; k<H; k++) {Serial.print(yOriginArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('8');
        for (int k=0; k<H; k++) {Serial.print(rollArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('9');
        for (int k=0; k<H; k++) {Serial.print(yawArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('10');
        for (int k=0; k<H; k++) {Serial.print(pitchArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('11');
        for (int k=0; k<H; k++) {Serial.print(xArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('12');
        for (int k=0; k<H; k++) {Serial.print(yArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('13');
        for (int k=0; k<H; k++) {Serial.print(AngleWArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('14');
        for (int k=0; k<H; k++) {Serial.print(AngleTTArray[k],4); Serial.print(',');}
        Serial.println(' ');
        //Serial.print('15');
        for (int k=0; k<H; k++) {Serial.print(TurntableInputArray[k],4); Serial.print(',');}        
        Serial.println(' ');
        //Serial.print('16');
        for (int k=0; k<H; k++) {Serial.print(WheelInputArray[k],4); Serial.print(',');}        
        Serial.println(' ');
        //Serial.print('17');
        for (int k=0; k<H; k++) {Serial.print(ddxArray[k],4); Serial.print(',');}        
        Serial.println(' ');
        //Serial.print('18');
        for (int k=0; k<H; k++) {Serial.print(ddyArray[k],4); Serial.print(',');}        
        Serial.println(' ');
        //Serial.print('19');
        for (int k=0; k<H; k++) {Serial.print(ddzArray[k],4); Serial.print(',');} 
        Serial.println();       
        mode='R';
        }
